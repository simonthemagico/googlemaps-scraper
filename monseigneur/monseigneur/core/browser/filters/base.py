...
from monseigneur.monseigneur.core.exceptions import ParseError
from monseigneur.monseigneur.core.tools.compat import unicode, basestring
...
class _Filter(object):
    ...
    def highlight_el(self, el, item=None):
        ...
        if self._key:
            el.attrib['title'] = 'monseigneur field: %s' % self._key
