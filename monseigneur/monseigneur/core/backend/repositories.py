...
from monseigneur.monseigneur.core.exceptions import BrowserHTTPError, BrowserHTTPNotFound, ModuleInstallError
from monseigneur.monseigneur.core.tools.log import getLogger
from monseigneur.monseigneur.core.tools.misc import to_unicode, find_exe
...
class Repository(object):
    ...
    def __init__(self, url):
        ...
        if self.url.startswith('file://'):
            ...
            # This is probably a file in ~/.monseigneur/repositories/, we
...
"""# List of Monseigneur repositories
#
...
class Repositories(object):
    ...
    def load_browser(self):
        from core.browser.browsers import Browser
        from core.browser.profiles import Monseigneur as MonseigneurProfile
        from core.tools.compat import getproxies

        class MonseigneurBrowser(Browser):
            PROFILE = MonseigneurProfile(self.version)
        if self.browser is None:
            self.browser = MonseigneurBrowser(
    ...
    def load(self):
        """
        Load repositories from ~/.local/share/monseigneur/repositories/.
        """
        self.repositories = []
    ...
    def retrieve_icon(self, module):
        """
        Retrieve the icon of a module and save it in ~/.local/share/monseigneur/icons/.
        """
        self.load_browser()
    ...
    def update_repositories(self, progress=PrintProgress()):
        ...
        and put them in ~/.local/share/monseigneur/repositories/.
            ...
            try:
                ...
                if repository.obsolete:
                    ...
                    progress.error('This repository does not receive updates anymore (since %s).\n'
                                   'Your monseigneur version is probably obsolete and should be upgraded.' % last_update)
...
class Keyring(object):
    ...
    def is_valid(self, data, sigdata):
        ...
        if gpg:
            ...
            gpg_homedir = mkdtemp(prefix='monseigneur_gpg_')
