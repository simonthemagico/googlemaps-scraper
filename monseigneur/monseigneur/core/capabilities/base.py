...
from monseigneur.monseigneur.core.tools.compat import unicode, long, with_metaclass, StrConv
...
class NotLoadedType(EmptyType):
    ...
    When you use :func:`core.tools.backend.Module.fillobj` on a object based on :class:`BaseObject`,
