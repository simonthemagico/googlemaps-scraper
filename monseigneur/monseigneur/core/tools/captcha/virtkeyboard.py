...
from monseigneur.core.tools.compat import basestring
    ...
    def check_symbols(self, symbols, dirname):
        ...
        for s in symbols:
            try:
                ...
                if dirname is None:
                    dirname = tempfile.mkdtemp(prefix='monseigneur_session_')
    ...
    def __init__(self, code_to_filedata):
        ...
        for char, hashes in self.char_to_hash.items():
            ...
            for hash in hash_to_code:
                ...
                path = tempfile.mkdtemp(prefix='monseigneur_session_')
...
class SimpleVirtualKeyboard(object):
    ...
    Parameters:
        ...
        :param browser: Browser of core session.
    ...
    def build_path(self, browser=None):
        if browser and browser.responses_dirname:
            ...
            return tempfile.mkdtemp(prefix='monseigneur_session_')
